...
_lr_signature = "INT ID PREFERENCE_LISTS_A PARTITION_B PARTITION_A END PREFERENCE_LISTS_Bgraph : nodes nodes edges edgesnodes : PARTITION_A pvertex_list ';' ENDnodes : PARTITION_B pvertex_list ';' ENDpvertex_list : pvertex_list ',' pvertexpvertex_list : pvertexpvertex : IDpvertex : ID '(' INT ')'pvertex : ID '(' INT ',' INT ')'vertex_list : vertex_list ',' IDvertex_list : IDedges : PREFERENCE_LISTS_A preference_lists ENDedges : PREFERENCE_LISTS_B preference_lists ENDpreference_lists : preference_lists pref_listpreference_lists : pref_listpref_list : ID ':' vertex_list ';'"
    
_lr_action_items = {'END':([14,16,18,20,21,27,36,],[23,25,-14,28,29,-13,-15,]),')':([24,34,],[31,37,]),'(':([8,],[15,]),'PREFERENCE_LISTS_A':([5,10,23,25,28,29,],[11,11,-3,-2,-11,-12,]),'ID':([3,4,11,12,13,18,20,21,26,27,35,36,],[8,8,19,19,8,-14,19,19,32,-13,38,-15,]),';':([6,7,8,9,22,31,32,33,37,38,],[14,-5,-6,16,-4,-7,-10,36,-8,-9,]),'PARTITION_B':([0,1,23,25,],[3,3,-3,-2,]),'$end':([2,17,28,29,],[0,-1,-11,-12,]),',':([6,7,8,9,22,24,31,32,33,37,38,],[13,-5,-6,13,-4,30,-7,-10,35,-8,-9,]),'PREFERENCE_LISTS_B':([5,10,23,25,28,29,],[12,12,-3,-2,-11,-12,]),'INT':([15,30,],[24,34,]),':':([19,],[26,]),'PARTITION_A':([0,1,23,25,],[4,4,-3,-2,]),}
...
_lr_goto_items = {'pref_list':([11,12,20,21,],[18,18,27,27,]),'nodes':([0,1,],[1,5,]),'edges':([5,10,],[10,17,]),'pvertex_list':([3,4,],[6,9,]),'pvertex':([3,4,13,],[7,7,22,]),'graph':([0,],[2,]),'preference_lists':([11,12,],[20,21,]),'vertex_list':([26,],[33,]),}
